              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-6">
                  <button 
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-white font-bold py-4 px-8 rounded-2xl transition-all shadow-xl shadow-primary/20 hover:-translate-y-0.5 group"
                  >
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-end">
                        <div className="space-y-1">
                          ...
                          <p className="text-[10px] font-bold text-primary uppercase tracking-tighter">Each question costs 1 coin</p>
                        </div>
                    ...
                    <div className="grid gap-3">
                      {activeSection.quizzes[currentQuizIndex].options.map((option, idx) => {
                        ...
                        let bgColor = "bg-white/80 dark:bg-card-dark/80 backdrop-blur-md hover:border-primary/50";
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      <button 
                        ...
                        className="flex-1 flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-white font-bold py-4 px-8 rounded-2xl transition-all shadow-xl shadow-primary/20 hover:-translate-y-0.5"
                      >
                        Next Section
