...
export default function AIChatInterface({ onClose, isModal = false }: AIChatInterfaceProps) {
  ...
  return (
    <div className={`flex flex-col bg-background-light dark:bg-background-dark transition-colors duration-300 overflow-hidden ${isModal ? 'h-full rounded-2xl' : 'h-screen w-full'}`}>
      {/* Header */}
      <header className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-card-dark z-10 shrink-0">
      ...
      >
        ...
        {isTyping && (
          ...
          >
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-4 py-3 rounded-2xl rounded-tl-none flex gap-1.5 items-center">
      ...
      <div className="p-4 bg-white dark:bg-card-dark border-t border-slate-200 dark:border-slate-800 shrink-0">
        <form 
          ...
          className="flex items-center gap-2 bg-slate-100 dark:bg-slate-900 rounded-2xl p-1.5 border border-slate-200 dark:border-slate-800 focus-within:border-indigo-500 transition-colors"
        >
          <input
            type="text"
            value={inputValue}
          ...
          <button
            ...
            className="size-10 rounded-xl bg-indigo-500 text-white flex items-center justify-center hover:bg-indigo-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-indigo-500/20 shrink-0"
          >
